...
import br.com.senac.tofudidonopi.taskManager.datasource.repositories.TaskRepository;
...
public class TaskServiceImpl implements TaskService {
    ...
    @Override
    public Optional<Object> findAdvancedJPQL(TaskStatus status, TaskPriority priority, Date startDate, Date endDate) {
        return Optional.empty();
    }

    @Override
    public Optional<Object> findByTitleCriteria(String title) {
        return Optional.empty();
    }
}
